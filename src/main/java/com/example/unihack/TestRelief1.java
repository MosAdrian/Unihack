...
public class TestRelief1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_relief1);

        rg1 = (RadioGroup)findViewById(R.id.rg1_3);
        rg2 = (RadioGroup)findViewById(R.id.rg2_3);
        rg3 = (RadioGroup)findViewById(R.id.rg3_3);
        rg4 = (RadioGroup)findViewById(R.id.rg4_3);
        rg5 = (RadioGroup)findViewById(R.id.rg5_3);
        rg6 = (RadioGroup)findViewById(R.id.rg6_3);
        rg7 = (RadioGroup)findViewById(R.id.rg7_3);
        rg8 = (RadioGroup)findViewById(R.id.rg8_3);
        rg9 = (RadioGroup)findViewById(R.id.rg9_3);
        rg10 = (RadioGroup)findViewById(R.id.rg10_3);

        btn = (Button)findViewById(R.id.submitBtn_3);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rb!=null) {
                    ...
                    if (Objects.equals(rasp1, "Dobrogea Plateau"))
                        k++;
                }
                ...
                if (rb != null) {
                    ...
                    if (Objects.equals(rasp2, "During Alpine orogenesis"))
                        k++;
                }
                ...
                if (rb != null) {
                    ...
                    if (Objects.equals(rasp6, "Andesite"))
                        k++;
                }
                ...
                if (rb != null) {
                    ...
                    if (Objects.equals(rasp9, "Limestone"))
                        k++;
                }
                ...
                if (rb != null) {
                    ...
                    if (Objects.equals(rasp10, "By deposting sediments"))
                        k++;
                }
                ...
                startActivity(new Intent(TestRelief1.this, AfisareScor.class));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Toast.makeText(TestRelief1.this,"Finish the test before exit",Toast.LENGTH_LONG).show();
        startActivity(new Intent(TestRelief1.this, TestRelief1.class));
        return;
    }
}